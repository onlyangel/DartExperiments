...
// Native classes
// Bound closures
$$.Bound__run__ZoneTimer = [P, {"": "BoundClosure;_self,_target,_receiver,_liblib3$_name",
  call$0: function() {
...
_BaseSendPort: {"": "Object;",
  ...
  call$1: function(message) {
    ...
    port._liblib2$_callback = new H._BaseSendPort_call_closure(completer, port);
...
_NativeJsSendPort_send_closure: {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    if (isolate == null)
      return;
    if (t2._receivePort.get$_liblib2$_callback() == null)
      return;
...
_NativeJsSendPort_send__closure: {"": "Closure;box_0,this_4,shouldSerialize_5",
  call$0: function() {
    ...
    if (t1.get$_liblib2$_callback() != null) {
...
BoundClosure: {"": "Closure;_self,_target,_receiver,_liblib3$_name",
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
  ...
  for (y = 0; y < h; ++y) {
    ...
    for (; x < w; ++x) {
      ...
      if (typeof t3 !== "string" && (typeof t3 !== "object" || t3 === null || t3.constructor !== Array && !H.isJsIndexable(t3, t3[init.dispatchPropertyName])))
        return S.procesImage$bailout(2, t1, h, d, x, y, t3, t2, w);
      t4 = (t2 + x) * 4;
      t5 = t3.length;
      if (t4 >>> 0 !== t4 || t4 >= t5)
        throw H.ioore(t3, t4);
      ...
      a = t3[t4];
      arr = [r, g, b, a];
      t4 = new S.procesImage_closure();
      t3 = arr.length - 1;
      if (t3 - 0 <= 32)
        H.Sort_insertionSort_(arr, 0, t3, t4);
      else
        H.Sort__dualPivotQuicksort(arr, 0, t3, t4);
      t3 = $.maxH;
      if (typeof t3 !== "number")
        return S.procesImage$bailout(6, t1, h, d, x, y, t3, t2, w, r, 0, g, b, arr, a);
      if (0 >= arr.length)
        throw H.ioore(arr, 0);
      t4 = arr[0];
      if (typeof t4 !== "number")
        return S.procesImage$bailout(7, t1, h, d, x, y, t3, t2, w, r, t4, g, b, arr, a);
      if (t3 < t4)
        t3 = t4;
      $.maxH = t3;
      S.addNum(r, $.get$red());
...
procesImage$bailout: function(state0, t1, h, d, x, y, t3, t2, w, r, t4, g, b, arr, a) {
  switch (state0) {
    case 0:
      J.drawImage$3$x($.theContext, $.theVideo, 0, 0);
      d = J.getImageData$4$x($.theContext, 0, 0, 400, 300);
...
printStrokeForMap: function(map, style) {
  ...
  while (true) {
    ...
    v = map.$index(map, "" + x);
    val = v == null ? 0 : v;
    J.lineTo$2$x($.gContext, x, J.$sub$n($.maxH, val));
    ++x;
  }
...
// Native classes
H.defineNativeMethods("AutocompleteErrorEvent|CanvasGradient|CanvasPattern|DOMError|ErrorEvent|Event|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|SpeechRecognitionError", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function ReceivePortImpl(_id, _liblib2$_callback) {
    this._id = _id;
  ...
  ReceivePortImpl.prototype.get$_liblib2$_callback = function() {
  ...
  function BoundClosure(_self, _target, _receiver, _liblib3$_name) {
    this._self = _self;
  ...
  function _ZoneTimer(_zone, _callback, _timer) {
    this._zone = _zone;
  ...
  function Bound__run__ZoneTimer(_self, _target, _receiver, _liblib3$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib3$_name = _liblib3$_name;
  ...
  function Navigator_getUserMedia_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  Navigator_getUserMedia_closure.builtin$cls = "Navigator_getUserMedia_closure";
  if (!"name" in Navigator_getUserMedia_closure)
    Navigator_getUserMedia_closure.name = "Navigator_getUserMedia_closure";
  $desc = $collectedClasses.Navigator_getUserMedia_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Navigator_getUserMedia_closure.prototype = $desc;
  function Navigator_getUserMedia_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  Navigator_getUserMedia_closure0.builtin$cls = "Navigator_getUserMedia_closure0";
  if (!"name" in Navigator_getUserMedia_closure0)
    Navigator_getUserMedia_closure0.name = "Navigator_getUserMedia_closure0";
  $desc = $collectedClasses.Navigator_getUserMedia_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Navigator_getUserMedia_closure0.prototype = $desc;
  ...
  function procesImage_closure() {
  }
  procesImage_closure.builtin$cls = "procesImage_closure";
  if (!"name" in procesImage_closure)
    procesImage_closure.name = "procesImage_closure";
  $desc = $collectedClasses.procesImage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  procesImage_closure.prototype = $desc;
  function addNum_closure(m_0, str_1) {
    this.m_0 = m_0;
    this.str_1 = str_1;
  }
  addNum_closure.builtin$cls = "addNum_closure";
  if (!"name" in addNum_closure)
    addNum_closure.name = "addNum_closure";
  $desc = $collectedClasses.addNum_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  addNum_closure.prototype = $desc;
  ...
  MediaElement.prototype.set$autoplay = function(receiver, v) {
    return receiver.autoplay = v;
  };
